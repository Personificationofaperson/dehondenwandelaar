...
export const BRONNEN = {
  google: {
    naam: "Google",
    kleur: "#4285F4",
    // Het bedrijfsprofiel, aangeroepen via de knowledge-graph-id. De lange
    // deel-URL van Google zit vol meetparameters die na verloop van tijd
    // vervallen, deze korte vorm blijft werken.
    url: "https://www.google.com/search?kgmid=/g/11z3p20n2h",
  },
  ringtwice: {
    naam: "Ring Twice",
    kleur: "#F5A623",
